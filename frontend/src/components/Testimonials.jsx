...
function Testimonials({profile, content, name, about}) {
  return (
    <>
      <div className='group relative w-[180px] md:w-[240px] h-[170px] md:h-[240px] lg:hover:h-[295px] p-3 md:p-5 text-[#000000] bg-[#FFFFFF] rounded-[16px] transition-normal duration-150 ' >
            ...
            <p className=' md:h-[120px] lg:group-hover:h-[170px] text-[10px] md:text-[13px] md:leading-5 lg:group-hover:leading-7 my-4 md:my-6 ' >{content}</p>
