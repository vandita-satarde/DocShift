...
function Testimonials({profile, content, name, about}) {
  return (
    <>
      <div className='group relative w-[180px] md:w-[240px] h-[170px] md:h-[230px] hover:h-[285px] p-3 md:p-5 text-[#000000] bg-[#FFFFFF] rounded-[16px] ' >
            ...
            <p className='text-[10px] md:text-[13px] md:leading-5 group-hover:leading-8 my-4 md:my-6 ' >{content}</p>
