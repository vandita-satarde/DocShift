...
function Features({ name }) {
    return (
        <>
            <div className=' bg-white text-[#0E1836] px-3 md:px-4 lg:px-7 py-2 md:py-5 w-[135px] md:w-[228px] lg:w-[300px] md:h-[370px] tracking-wide shadow-md hover:shadow-lg hover:scale-103'>
