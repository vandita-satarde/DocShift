    ...
    return (
        <>
            <div className=' bg-white text-[#0E1836] px-3 md:px-7 py-2 md:py-5 w-[135px] md:w-[300px] md:h-[370px] tracking-wide shadow-md'>
                ...
                <button className='cursor-pointer mt-6 md:mt-14 mb-3 md:mb-10 w-[90px] md:w-[170px] h-[25px] md:h-[46px] bg-[#FD6B70] hover:bg-[#f9454b] text-[#FFFFFF] rounded-4xl text-[11px] md:text-[18px] '>Get Started</button>
