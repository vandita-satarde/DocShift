    ...
    return (
        <>
            <div className='text-[#0E1836] '>
                {/* HeroSection */}
                <div className='bg-[#F5F9FE] flex md:gap-30 lg:gap-40 px-7 md:px-30 pt-22 md:pt-30 lg:pt-32 pb-5 md:pb-8'>
                    <div className='flex w-1/2 gap-5 md:gap-10 lg:gap-20'>
                        ...
                        <img src={image} className='object-cover w-[50px] md:w-[260px] lg:w-[210px] h-[180px] md:h-[200px] lg:h-[500px] rounded-[10px] mt-8 lg:mt-16' />
                    </div>
                    <div className='w-1/2 mt-6 md:mt-13'>
                        ...
                        <p className='text-[9px] md:text-[19px] my-3 md:my-8 leading-3 md:leading-9 md:tracking-wider'>{description}</p>
                        <button className='w-[80px] md:w-[150px] h-[24px] md:h-[46px] bg-[#FD6B70] text-[#FFFFFF] rounded-sm text-[10px] md:text-[18px] '>Get Started</button>
                    </div>
                </div>

                {/* upload files in multiple formats */}
                <div className='py-5 md:py-10 lg:py-13 space-y-4 md:space-y-8 lg:space-y-12'>
                    <p className='font-semibold text-[15px] md:text-[40px] lg:text-[45px] text-center leading-5 md:leading-14'>Upload files in<br /> multiple formats</p>
