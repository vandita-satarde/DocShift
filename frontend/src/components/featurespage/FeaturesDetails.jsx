    ...
    return (
        <>
            <div className='text-[#0E1836] '>
                {/* HeroSection */}
                <div className='bg-[#F5F9FE] flex md:gap-60 px-4 md:px-30 pt-25 md:pt-46 pb-6 md:pb-8'>
                    <div className='flex w-1/2 gap-2 md:gap-19'>
                        <img src={image} className='object-cover w-[50px] md:w-[260px] h-[180px] md:h-[650px] rounded-[10px] ' />
                        <img src={image} className='object-cover w-[50px] md:w-[260px] h-[180px] md:h-[650px] rounded-[10px] mt-10 md:mt-20' />
                    </div>
                ...
                <div className='py-6 md:py-20 space-y-5 md:space-y-20'>
