...
function AllTools({ image, name, description, imgDiv='', img='' }) {
    return (
        <>
            <div className='w-[120px] md:w-[310px] h-[110px] md:h-[245px] bg-[#FFFFFF] text-[#0E1836] flex flex-col justify-center items-center text-center px-2 md:px-8 shadow-lg hover:shadow-xl hover:border hover:border-gray-200 cursor-pointer '>
