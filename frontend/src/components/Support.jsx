...
function Support({mainDiv='bg-[#0E1836] text-white', title1, subtext1, listItem1, listItem2, listItem3, listItem4, listItem5, title2, button, subtext2}) {
    return (
        <>
            <div className={`${mainDiv} text-center space-y-6 md:space-y-12 lg:space-y-15 px-6 lg:px-40 py-11 md:py-12 lg:py-25 tracking-wide md:tracking-widest `}>
                ...
                <ul className='list-disc text-[10px] md:text-[18px] lg:text-[22px] text-left space-y-1.5 md:space-y-3 lg:space-y-6 ml-8 md:ml-16 lg:ml-30 '>
                    <li>{listItem1}</li>
                    <li>{listItem2}</li>
                    <li>{listItem3}</li>
                    <li>{listItem4}</li>
