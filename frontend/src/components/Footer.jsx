  ...
  return (
    <>
      <div className='text-[#C0C0C0] bg-[#091432]'>
        <div className={`${className} flex flex-col md:flex-row items-center gap-6 md:gap-23 lg:gap-30 px-10 md:px-15 lg:px-50 py-9 md:h-[260px] lg:h-[370px] text-[11px] md:text-[15px] lg:text-[19px]`}>
        ...
        <p className='text-[8px] md:text-[13px] text-center p-3 md:p-5 '>© copyrighty 2025 Design and Developed with love by TARS TECHNOLOGIES</p>
      </div>
    </>
  )
}
