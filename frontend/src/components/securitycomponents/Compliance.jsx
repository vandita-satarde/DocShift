...
function Compliance({image, name, subcontent, content}) {
    return (
        <>
            <div className='bg-[#1F2E57] hover:scale-105 hover:duration-200 text-[8px] md:text-[14px] md:leading-6 tracking-wide md:tracking-wider rounded-sm w-[190px] md:w-[390px] h-[200px] md:h-[440px] flex flex-col items-center px-3 md:px-10 py-4 md:py-5 '>
