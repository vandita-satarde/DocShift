    ...
    return (
        <>
            <div className='text-[#0E1836]'>
                <div className='bg-[#F5F9FE] text-center px-3 md:px-30 pb-10 md:pb-18 pt-26 md:pt-[110px] '>
            ...
            <div className='bg-[#0E1836] text-white py-10 md:py-20 tracking-wide md:tracking-wider '>
                <p className='text-[17px] md:text-[55px] text-center font-semibold leading-6 md:leading-16'>Why {name}<br/>Choose DocShift</p>
            ...
            <p className='text-[20px] md:text-[58px] font-bold text-center bg-[#F5F9FE] text-[#0E1836] pt-8 md:pt-15 '>{features}</p>
        </>
    )
}
