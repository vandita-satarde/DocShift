        ...
        <>
            <div className={`hover:scale-104 duration-200 px-3 md:px-6 lg:px-15 py-3 md:py-4 lg:py-7 rounded-lg flex items-center md:items-end gap-3 md:gap-5 lg:gap-30 ${maindiv} `}>
                ...
                <div className='text-left '>
                    ...
                    {showbutton && (
                        <Link to={link} >
                            <button className='cursor-pointer w-[80px] md:w-[140px] lg:w-[170px] h-[20px] md:h-[40px] lg:h-[45px] text-[#FD6B70] hover:text-white hover:bg-[#FD6B70] border border-[#FD6B70] rounded-4xl text-[9px] md:text-[17px] lg:text-[20px] '>Get Started</button>
                        </Link>
                    )}
                </div>
            </div>
