  ...
  return (
    <>
        ...
        <div className='bg-[#F5F9FE] text-[#0E1836] text-center px-6 md:px-16 lg:px-30 pt-26 md:pt-41 pb-7 md:pb-20 '>
            ...
            <div className='w-[300px] md:w-[640px] lg:w-[560px] mx-auto space-y-1 md:space-y-2 lg:space-y-6 mt-14 md:mt-34 '>
                <p className='text-[18px] md:text-[34px] lg:text-[55px] font-semibold md:leading-12 lg:leading-16 '>Ready to<br className='hidden lg:block'/> Elevate Your</p>
                ...
                <button className='w-[80px] md:w-[150px] lg:w-[170px] h-[22px] md:h-[40px] lg:h-[45px] text-white bg-[#FD6B70] rounded-4xl text-[11px] md:text-[18px] lg:text-[20px] '>Get Started</button>
            </div>
        </div>
