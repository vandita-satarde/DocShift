    ...
    return (
        <>
            ...
            <div className='flex flex-wrap justify-center gap-x-9 md:gap-x-18 lg:gap-x-70 -gap-y-1 md:gap-y-5 lg:gap-y-10 bg-[#F5F9FE] pb-5 md:pb-15 md:px-20 lg:px-50'>
                <Subfeature textColor='text-[#0E1836]' mainDiv='w-28 md:w-60 lg:w-100' name='Custom Zaps' description='Automate tasks like uploading files to DocShift or sharing documents.' />
                <Subfeature textColor='text-[#0E1836]' mainDiv='w-28 md:w-60 lg:w-100' name='Integration Examples' description='Sync with Slack for notifications, Trello for project tracking, or CRM tools for client management.' />
                <Subfeature textColor='text-[#0E1836]' mainDiv='w-28 md:w-60 lg:w-100' name='No-Code Setup' description='Create automations without coding expertise.' />
                <Subfeature textColor='text-[#0E1836]' mainDiv='w-28 md:w-60 lg:w-100' name='Scalable Workflows' description='Automate repetitive tasks for large teams.' />
            </div>
