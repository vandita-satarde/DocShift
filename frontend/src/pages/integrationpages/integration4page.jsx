  ...
  return (
    <>
            ...
            <div className='flex gap-50 bg-[#F5F9FE] pb-5 md:pb-15 px-10 md:px-50'>
                <div>
                    <Subfeature textColor='text-[#0E1836]' name='Custom Zaps' description='Automate tasks like uploading files to DocShift or sharing documents.' />
                    <Subfeature textColor='text-[#0E1836]' name='Integration Examples' description='Sync with Slack for notifications, Trello for project tracking, or CRM tools for client management.' />
                </div>
                <div>
                    <Subfeature textColor='text-[#0E1836]' name='No-Code Setup' description='Create automations without coding expertise.' />
                    <Subfeature textColor='text-[#0E1836]' name='Scalable Workflows' description='Automate repetitive tasks for large teams.' />
                </div>
            </div>
