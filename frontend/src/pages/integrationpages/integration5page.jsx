...
function integration5page() {
  return (
    <>
            ...
            <div className='flex gap-6 md:gap-50 bg-[#F5F9FE] pb-5 md:pb-15 px-10 md:px-50'>
                <div>
                    <Subfeature textColor='text-[#0E1836]' name='RESTful API' description='Access DocShift’s features (upload, edit, share) programmatically.' />
                    <Subfeature textColor='text-[#0E1836]' name='Our Custom Workflows' description=' Integrate with ERP, CRM, or proprietary systems.' />
                </div>
                <div>
                    <Subfeature textColor='text-[#0E1836]' name='Scalable Endpoints' description='Handle large-scale document processing for enterprises.' />
                    <Subfeature textColor='text-[#0E1836]' name='Secure Authentication' description='Use JWT or OAuth2 for secure API access.' />
                </div>
            </div>
