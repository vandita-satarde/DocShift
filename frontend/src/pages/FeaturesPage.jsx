        ...
        <>
            ...
            <div className='flex flex-col md:flex-row justify-center md:justify-start py-25 md:py-40 bg-[#F5F9FE] '>
                ...
                <div className='relative ml-20 md:ml-25'>
                    ...
                    <img src={featureMain2} className='absolute top-20 md:top-39 left-12 md:left-32 h-[140px] md:h-[320px] w-auto ' />
                    <img src={featureMain3} className='absolute top-35 md:top-78 -left-3 h-[140px] md:h-[300px] w-auto rounded ' />
                </div>
            </div>
